...
<?php $page_title = 'pesanan yang dibuat'; include __DIR__ . '/../../app/partials/admin_head.php'; ?>
...
<section class="placed-orders">
   ...
   <h1 class="heading">pesanan yang dibuat</h1>
   ...
   <div class="box">
      ...
      <form action="" method="POST">
         ...
         <div class="flex-btn">
            ...
            <a href="placed_orders.php?delete=<?= $fetch_orders['id']; ?>" class="delete-btn" onclick="return confirm('hapus pesanan ini?');">delete</a>
         </div>
      </form>
   </div>
   <?php
