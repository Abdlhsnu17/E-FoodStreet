...
<?php $page_title = 'checkout'; include __DIR__ . '/../app/partials/head.php'; ?>
...
<form action="" method="post">
   ...
   <div class="user-info">
      ...
      <p><i class="fas fa-map-marker-alt"></i><span><?php if($fetch_profile['address'] == ''){echo 'harap mengisi alamat pengiriman dengan klik tombol Update Alamat untuk melanjutkan pesanan';}else{echo $fetch_profile['address'];} ?></span></p>
